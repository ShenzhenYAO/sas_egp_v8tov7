/* To update a research doc template according to the template */
...
const srcdocxzip = new AdmZip(srcfilepath);
...
async function make_docx() {
    ...
    let { jq_src, theoriginsrcxmlstr_src } = await read_xml_from_src(srcdocxzip)
...
async function read_xml_from_src(srcdocxzip) {
